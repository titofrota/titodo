...
**This app is using Rails 8.0.1 and Ruby 3.4.1**. The screenshot doesn't get
...
```sh
git clone https://github.com/nickjj/docker-rails-example titodo
cd titodo
...
The app is named `titodo` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "titodo" and update a few Docker related resources.
