...
#       post todo_items_url, params: { todo_item: { completed: @todo_item.completed, due_date: @todo_item.due_date, name: @todo_item.name, todo_list_id: @todo_item.todo_list_id } }
#     end
...
#     patch todo_item_url(@todo_item), params: { todo_item: { completed: @todo_item.completed, due_date: @todo_item.due_date, name: @todo_item.name, todo_list_id: @todo_item.todo_list_id } }
